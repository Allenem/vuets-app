    ...
    <el-row>
      ...
      <el-col :xs='10' :sm='12' :md='14' :lg='16' :xl='18'>
        <div class="system-info">
          <img class="logo" src="@/assets/paperCraneBlue.png" alt="">
          <span class="title">Allenem在线</span>
        </div>
      </el-col>
...
<script lang='ts'>
import {Component,Vue} from 'vue-property-decorator' // inport decorator
